                        ...
                        <h1>
                            <a href="<?php echo base_url(); ?>index.php/TrangChuController"
                                style="color: #ba0000; font-family: 'Ubuntu', sans-serif;"><img
                                    src="<?php echo base_url(); ?>img/logotrangchu.png" alt=""
                                    style="width: 100px; height: 60px;border-radius: 100%"> MU STORE</a>
                        </h1>
                    </div>
                </div>
                                ...
                                <div id="camera" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul style="list-style:none">
                                            ...
                                            <li><a
                                                    href="<?php echo base_url(); ?>index.php/SanPhamBanController/camera/13">13MP</a>
                                            </li>
                                            <li><a
                                ...
                                <div id="bonhotrong" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul style="list-style:none">
                                            ...
                                            <li><a
                                                    href="<?php echo base_url(); ?>index.php/SanPhamBanController/bonhotrong/128">128GB</a>
                                            </li>
                                            <li><a
                                ...
                                <div id="manhinh" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul style="list-style:none">
                                            ...
                                            <li><a
                                                    href="<?php echo base_url(); ?>index.php/SanPhamBanController/kichthuocmanhinh/5.5">5.5'</a>
                                            </li>
                                            <li><a
                ...
                <div class="col-md-6">
                    <div class="footer-menu">
                        ...
                        <p>
                            ...
                            hàng trên toàn quốc. MU Shop cung cấp dịch vụ
